...
export default function SignUpPage() {
  ...
  const handleSuccessfulSignup = (user: User | null) => {
    toast({
        title: 'Account Created',
        description: 'Welcome to BookSnap! Let\'s set up your profile.',
      });
  ...
  return (
    <div className="container mx-auto flex h-full max-w-sm flex-col items-center justify-center gap-6 px-4 py-8">
      <div className="text-center">
        <h1 className="font-headline text-4xl">Create an Account</h1>
        <p className="text-muted-foreground">Join BookSnap to start your library.</p>
      </div>
